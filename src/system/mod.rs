...
use drop::{
    ...
    crypto::{
        ...
        sign::{SignError, VerifyError},
    },
    message,
    system::{Handle, Processor, Sampler, Sender, SenderError},
    Message,
};
use futures::future::OptionFuture;
use postage::{dispatch, prelude::*};
...
pub mod test {
    ...
    mod tests {
        ...
        async fn deliver_then_announce() {
            use drop::{system::AllSampler, test::keyset};
            use futures::stream::{FuturesUnordered, StreamExt};
